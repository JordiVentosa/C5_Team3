# task_e_eval.py
"""
Loads the best task e model and evaluates it on the full validation set.
Usage:
    python task_e_eval.py \
        --vit_model    /home/mcvstudent20/C5_Team3/Week4/modelo_vit_gpt2 \
        --qwen_model   /home/mcvstudent20/C5_Team3/Week4/modelo_qwen35_4b \
        --lora_dir     outputs/task_e/qwen35_4b/lora_r8_a16/best_model/qwen_lora \
        --proj_path    outputs/task_e/qwen35_4b/lora_r8_a16/best_model/projection.pt \
        ...
        --output_file  outputs/results/task_e_eval.json
"""
import argparse
import json
import sys
...
from task_e import ViTQwenCaptioner
...
def parse_args():
    ...
    parser.add_argument("--output_file",  default="outputs/results/task_e_eval.json")
...
def main():
    ...
    print(f"[INFO] Val set: {len(dataset)} samples", flush=True)
    ...
    print_metrics(metrics, title="Task E — Val evaluation")
    ...
    print(f"[INFO] Saved to {out_path}", flush=True)
