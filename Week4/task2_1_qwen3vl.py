"""
Task 2.1 - Evaluate using Qwen/Qwen3-VL-8B-Instruct on VizWiz

Use:
    python task2_1_qwen3vl.py \
        --img_dir data/vizwiz/val \
        --ann_file data/vizwiz/annotations/val.json \
        --output_file outputs/task2_1_qwen3vl \
        --prompt_mode basic
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate Qwen3-VL-8B on VizWiz")
    parser.add_argument('--img_dir', type=str, required=True,
                        help="Path to folder with .jpg images")
    parser.add_argument('--ann_file', type=str, required=True,
                        help="Path to val.json / test.json")
    parser.add_argument('--output_file', type=str,
                        default="outputs/task2_1_qwen3vl",
...
def main():
    ...
    print_metrics(metrics, title="Qwen3-VL-8B Metrics")
